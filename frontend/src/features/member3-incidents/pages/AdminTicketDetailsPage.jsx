    ...
    return (
      <div className="rounded-2xl border border-slate-800 bg-slate-900/60 p-5 shadow-lg shadow-slate-950/60">
        ...
        <div className="mt-4">
          <Link
            to="/incidents/admin"
            className="inline-flex items-center justify-center rounded-full border border-slate-600 bg-slate-800 px-4 py-2 text-xs font-semibold text-slate-200 transition hover:bg-slate-700"
          >
    ...
    <div className="space-y-6">
        ...
        <div className="flex flex-wrap items-start justify-between gap-4">
          <div className="space-y-2">
            ...
            <div className="flex flex-wrap items-center gap-2">
              ...
              {unreadCount > 0 && (
                <span className="rounded-full border border-blue-500/40 bg-blue-500/10 px-2 py-0.5 text-[10px] font-semibold text-blue-200">
        ...
        <div className="mt-4 grid gap-4 md:grid-cols-2">
          <label className="grid gap-1 text-xs font-medium uppercase tracking-wide text-slate-400">
            ...
            >
              ...
              {technicians.map((t) => (
                <option key={t.email} value={t.email} className="bg-slate-800">
          ...
          <label className="grid gap-1 text-xs font-medium uppercase tracking-wide text-slate-400">
            ...
            <textarea
              ...
              className="rounded-lg border border-slate-600 bg-slate-800 px-3 py-2 text-sm text-slate-50 outline-none ring-0 transition placeholder:text-slate-500 focus:border-blue-500 focus:ring-2 focus:ring-blue-500/30"
            />
          </label>
        </div>
      ...
      <div className="rounded-2xl border border-slate-800 bg-slate-900/60 p-5 shadow-lg shadow-slate-950/60">
        ...
        <div className="mt-5 flex flex-col gap-4 md:flex-row md:items-end">
          <label className="grid w-full gap-1 text-xs font-medium uppercase tracking-wide text-slate-400">
            Reply Message
            <textarea
              value={replyMessage}
          ...
          <div className="flex flex-col gap-3 md:ml-2">
            <label className="inline-flex items-center gap-2 rounded-xl border border-slate-700 bg-slate-800/80 px-3 py-2">
              <input
                type="checkbox"
                checked={sendNotification}
                onChange={(e) => setSendNotification(e.target.checked)}
                className="rounded border-slate-500 bg-slate-800 text-blue-500 focus:ring-blue-500/40"
              />
